    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL1:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/Tech_Shreyansh")
                sys.exit()
        ...
        if FORCE_SUB_CHANNEL3:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/Tech_Shreyansh1")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/Tech_Shreyansh1")
            sys.exit()
...
( '.( OO )_ ( \( -O )             ( OO )  /              ( OO ). (  OO) )   
 ...
 `--'   `--' `--' '--'  `------'  `--' `--'     `-----'  `-----'    `--'  
    ...
    def run(self):
        ...
        self.LOGGER(__name__).info("Bot is now running. Thanks to @Tech_Shreyansh29")
        try:
            loop.run_forever()
