# Don't Remove Credit @MrGhostsx2, @Tech_Shreyansh
# Ask Doubt on telegram @Tech_Shreyansh
#
# Copyright (C) 2025 by MrGhostsx@Github, < https://github.com/MrGhostsx-Bots >.
#
# This file is part of < https://github.com/MrGhostsx/FileStore > project,
# and is released under the MIT License.
# Please see < https://github.com/MrGhostsx/FileStore/blob/master/LICENSE >
#
# All rights reserved.
#
    ...
    if id in ADMINS:
        ...
        if TOKEN:
            ...
            if not verify_status['is_verified']:
                token = ''.join(random.choices(mrghostsx.ascii_letters + mrghostsx.digits, k=10))
...
#=====================================================================================##
# Don't Remove Credit @MrGhostsx, @Tech_Shreyansh2
# Ask Doubt on telegram @Tech_Shreyansh
