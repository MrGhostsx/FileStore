# Don't Remove Credit @Tech_Shreyansh, @Tech_Shreyansh29
# Ask Doubt on telegram @Tech_Shreyansh
#
# Copyright (C) 2025 by MrGhostsx@Github, < https://github.com/MrGhostsx >.
#
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Tech_Shreyansh29")
#OWNER ID
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @Tech_Shreyansh29</b>")
